                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("idy Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a idy address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and idy: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About idy Core"), this);
    aboutAction->setStatusTip(tr("Show information about idy Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for idy"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your idy addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified idy addresses"));
    ...
    openAction->setStatusTip(tr("Open a idy: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the idy Core help message to get a list with possible idy command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("idy Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to idy network", "", count));
}
...
{
    QString strTitle = tr("idy Core"); // default title

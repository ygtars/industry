...
#   c) node1 mines 32 blocks, so now node 0 has 500000idy, node 1 has 4250idy, node2 has none.
#   d) node0 sends 601 idy to node2, in two transactions (301 idy, then 300 idy).

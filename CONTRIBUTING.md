Contributing to IDY Core
==================================

The IDY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the IDY Core project, and is not to be
confused with overall IDY Network Protocol consensus changes.

Whether a pull request is merged into IDY Core rests with the project merge
...
Patches that change IDY consensus rules are considerably more involved than
...
Where a patch set proposes to change the IDY consensus, it must have been
...
The project leader is the release manager for each IDY Core release.

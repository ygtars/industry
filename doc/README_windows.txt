...
Intro
-----
IDY (IDY) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. IDY utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run IDY-qt.exe.

IDY Core is the original IDY client and it builds the backbone of the network.
However, it downloads and stores the entire history of IDY transactions;

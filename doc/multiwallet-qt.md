...
In order to support loading of multiple wallets in IDY-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is IDY.cpp.
...
Changes to IDY.cpp
----------------------
IDY.cpp is the entry point into IDY-qt, and as such, will require some minor modifications to provide hooks for

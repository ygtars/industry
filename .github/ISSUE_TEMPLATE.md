...
This issue tracker is only for technical issues related to idy Core.
General idy questions and/or support requests and are best directed to the [idy Discord](https://discord.gg/CcAT5Av).
...
### What version of idy Core are you using?
